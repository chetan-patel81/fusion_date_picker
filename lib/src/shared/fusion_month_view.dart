...
class FusionMonthView extends StatelessWidget {
  /// Displays the months of a given year and allows choosing a month.
  ///
  /// Months are arranged in a rectangular grid with tree columns.
  FusionMonthView({
    ...
    assert(() {
      ...
      final max = FusionDateUtilsX.monthOnly(maxDate);
      final min = FusionDateUtilsX.monthOnly(minDate);
      final selected = FusionDateUtilsX.monthOnly(selectedDate!);
  ...
  Widget build(BuildContext context) {
    ...
    final DateTime startMonth = FusionDateUtilsX.monthOnly(minDate);
    final DateTime endMonth = FusionDateUtilsX.monthOnly(maxDate);
    DateTime? selectedMonth;

    if (selectedDate != null) {
      selectedMonth = FusionDateUtilsX.monthOnly(selectedDate!);
    }
    ...
    while (month < 12) {
      ...
      final bool isCurrentMonth =
          monthToBuild == FusionDateUtilsX.monthOnly(currentDate);
    ...
    return GridView.custom(
      ...
      gridDelegate: const FusionPickerGridDelegate(columnCount: 3, rowCount: 4),
