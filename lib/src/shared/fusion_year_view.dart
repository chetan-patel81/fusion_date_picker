...
class FusionYearView extends StatelessWidget {
  ...
  FusionYearView({
    ...
    assert(() {
      ...
      final max = FusionDateUtilsX.yearOnly(maxDate);
      final min = FusionDateUtilsX.yearOnly(minDate);
      final selected = FusionDateUtilsX.yearOnly(selectedDate!);
