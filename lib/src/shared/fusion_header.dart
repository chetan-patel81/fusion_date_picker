...
import 'fusion_leading_date.dart';
...
/// See also:
///
///  * [FusionLeadingDate], a widget that shows an indication of the opened year/month.
///
///
class FusionHeader extends StatelessWidget {
  /// Creates a new [FusionHeader] instance.
  ///
