...
/// See also:
///
///  * [FusionRangeDatePicker], which provides the calendar grid used by the range picker dialog.
///
Future<DateTimeRange?> showFusionRangePickerDialog({
