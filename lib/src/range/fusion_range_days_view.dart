...
import 'package:fusion_date_picker/src/shared/fusion_picker_grid_delegate.dart' show FusionPickerGridDelegate;
...
/// the week.
class FusionRangeDaysView extends StatelessWidget {
  /// Displays the days of a given month and allows choosing  days range.
  ///
  /// The days are arranged in a rectangular grid with one column for each day of
  /// the week.
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.custom(
      ...
      gridDelegate: const FusionPickerGridDelegate(columnCount: 7, rowCount: 7),
